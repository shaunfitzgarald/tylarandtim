    ...
    return (
        <Box sx={{ p: 3 }}>
            ...
            <Dialog open={openModal} onClose={handleCloseModal} maxWidth="sm" fullWidth>
                <DialogTitle>{editingGuest ? "Edit Guest RSVP" : "Add New Guest RSVP"}</DialogTitle>
                <DialogContent dividers>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField 
                                fullWidth label="Plus Ones" type="number" variant="outlined" 
                                InputProps={{ inputProps: { min: 0, max: 10 } }}
                                value={formData.plusOnes} onChange={(e) => setFormData({...formData, plusOnes: parseInt(e.target.value) || 0})}
                            />
                        </Grid>
                        <Grid item xs={12}>
                            <TextField 
                                fullWidth label="Dietary Restrictions" variant="outlined" multiline rows={2}
